...
<header>
    ...
    <div class="container mt-5">
        ...
        <form method="POST" enctype="multipart/form-data" id="submitClaimForm" class="shadow p-4 bg-white rounded">
            <p class="text-center mb-5 text-muted">Please provide all the necessary information to process your claim effectively.</p>
            ...
            <div class="row g-3 mb-4">
                <div class="col-md-6">
                    ...
                    <input type="text" id="policyholder_name" name="policyholder_name" class="form-control" required>
                </div>
                <div class="col-md-6">
            ...
            <div class="row g-3 mb-4">
                ...
                <div class="col-12">
                    ...
                    <textarea id="third_party_info" name="third_party_info" class="form-control" rows="3"></textarea>
                </div>
            </div>
            ...
            <div class="row g-3 mb-4">
                <div class="col-md-6">
                    ...
                    <input type="file" id="insurance_certificate" name="insurance_certificate" class="form-control" required>
                </div>
                <div class="col-md-6">
